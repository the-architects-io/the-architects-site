...
export const RPC_ENDPOINT_DEVNET =
...
export const BUILD_REWARD_WALLET =
...
export const DDK_ASSET_SHDW_DRIVE_ADDRESS =
  process.env.NEXT_PUBLIC_DDK_ASSET_SHDW_DRIVE_ADDRESS || "";
...
export const NEXT_PUBLIC_ARCHITECTS_COLLECTION_WALLET_ADDRESS = process.env.NEXT_PUBLIC_ARCHITECTS_COLLECTION_WALLET_ADDRESS;
