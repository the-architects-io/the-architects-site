...
import { Collection, Creator, TreeCreationMethod } from "@/app/blueprint/types";
...
export default function SetCreatorsPage({
  ...
  const formik = useFormik({
    ...
    onSubmit: async ({ creators }) => {
      if (!collection?.id || !treeMaxBufferSize || !treeMaxDepth) {
        showToast({
      ...
      <FormikProvider value={formik}>
        <ContentWrapper className="flex">
          ...
          <div className="flex flex-col items-center w-full px-8 mb-16">
            ...
            <div className="flex flex-col items-center mt-16 w-full md:w-[500px]">
