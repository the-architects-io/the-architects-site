...
export enum BlueprintApiActions {
  ADD_CHARACTERS_FROM_NFTS = "ADD_CHARACTERS_FROM_NFTS",
  ADD_COST_COLLECTIONS = "ADD_COST_COLLECTIONS",
  ADD_ITEM_COLLECTIONS = "ADD_ITEM_COLLECTIONS",
  ADD_ITEMS = "ADD_ITEMS",
  ADD_NFTS = "ADD_NFTS",
  ADD_TOKEN = "ADD_TOKEN",
  ADD_TOKENS = "ADD_TOKENS",
  BIND_ITEM_TO_TOKEN = "BIND_ITEM_TO_TOKEN",
  CREATE_DISPENSER = "CREATE_DISPENSER",
  DISPENSE_TOKENS = "DISPENSE_TOKENS",
  GET_TOKEN_BALANCES_FROM_HELIUS = "GET_TOKEN_BALANCES_FROM_HELIUS",
  GET_TOKEN_METADATA_FROM_HELIUS = "GET_TOKEN_METADATA_FROM_HELIUS",
  LINK_WALLET_TO_USER = "LINK_WALLET_TO_USER",
  MINT_TOKEN = "MINT_TOKEN",
  UPDATE_DISPENSER = "UPDATE_DISPENSER",
  UPDATE_DISPENSER_DISPLAY = "UPDATE_DISPENSER_DISPLAY",
  UPDATE_DISPENSER_REWARDS = "UPDATE_DISPENSER_REWARDS",
  UNBIND_ITEM_FROM_TOKEN = "UNBIND_ITEM_FROM_TOKEN",
  UNBIND_WALLET_FROM_USER = "UNBIND_WALLET_FROM_USER",
}
