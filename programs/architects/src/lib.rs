...
declare_id!("3WpsCAduMxrcQtAJ3QeWpcAzoEfDqniFSxdMLw1HFkU3");
...
pub mod anchor_escrow {
    ...
    const AUTHORITY_SEED: &[u8] = b"arch-authority";
    ...
    pub fn initialize(
        ...
        ctx.accounts.escrow_state.dispenser_id = dispenser_id;
    ...
    pub fn cancel(ctx: Context<Cancel>) -> Result<()> {
        let authority_seeds = &[
            &AUTHORITY_SEED[..],
            // add dispenser_id to seeds
            ctx.accounts.escrow_state.dispenser_id.as_bytes(),
